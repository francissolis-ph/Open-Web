...
<body>
  ...
  <nav class="nav-bar" id="nav-bar">
    ...
    <i
      title="Transactions"
      id="fa-exchange-alt"
      class="fas fa-exchange-alt nav-button"></i>
    <i
      title="Reference Tables"
      id="fa-table"
      class="fas fa-table nav-button"></i>
    <i title="Settings" id="fa-gear" class="fas fa-gear nav-button"></i>
  </nav>
  <main class="content-area" id="content-area">
    <div id="ca-home" class="ca-form ca-home">
      <form
        id="ca-home-form"
        class="ca-home-form"
        action=""
      ...
      <table>
        ...
        <?php
        $sql = "SELECT TOP 10 CONCAT(patlast, ', ', patfirst, ', ', patmiddle) AS sql_patname, patlast, patfirst, patmiddle, hpercode FROM hperson";
